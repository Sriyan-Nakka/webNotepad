...
!(function (e, t) {
  ...
  function () {
    ...
    var d = ((e = "") => {
      ...
      O = /[^\s\p{P}\p{S}]/u,
      j = k(/^((?![*_])punctSpace)/, "u")
        .replace(/punctSpace/g, D)
        .getRegex(),
      Q = /(?!~)[\p{P}\p{S}]/u,
      M = k(/link|precode-code|html/, "g")
        .replace(
          "link",
          /\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/,
        )
      ...
      N = k(H, "u").replace(/punct/g, Z).getRegex(),
      G = k(H, "u").replace(/punct/g, Q).getRegex(),
      X =
        "^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",
      W = k(X, "gu")
        .replace(/notPunctSpace/g, O)
        .replace(/punctSpace/g, D)
        .replace(/punct/g, Z)
        .getRegex(),
      F = k(X, "gu")
      ...
      Y = k(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/)
        ...
        .getRegex(),
      ee = k(A).replace("(?:--\x3e|$)", "--\x3e").getRegex(),
      te = k(
      ...
      pe = { normal: E, gfm: B, pedantic: q },
      ue = { normal: ae, gfm: ce, breaks: he, pedantic: oe },
      ge = {
        "&": "&amp;",
        "<": "&lt;",
        ">": "&gt;",
    ...
    function de(e, t) {
      if (t) {
        if (f.escapeTest.test(e)) return e.replace(f.escapeReplace, ke);
      } else if (f.escapeTestNoEncode.test(e))
        return e.replace(f.escapeReplaceNoEncode, ke);
      return e;
    }
    function fe(e) {
      try {
    ...
    var $e = class {
        ...
        hr(e) {
          ...
          if (t) return { type: "hr", raw: be(t[0], "\n") };
        }
        blockquote(e) {
      ...
      Re = class e {
        ...
        constructor(e) {
          ...
          let t = { other: f, block: pe.normal, inline: ue.normal };
          (this.options.pedantic
            ? ((t.block = pe.pedantic), (t.inline = ue.pedantic))
            : this.options.gfm &&
              ((t.block = pe.gfm),
              this.options.breaks
                ? (t.inline = ue.breaks)
        ...
        inlineTokens(e, t = []) {
          ...
          if (this.tokens.links) {
            ...
            e.length > 0 &&
              (n = n.replace(this.tokenizer.rules.inline.reflinkSearch, (t) =>
                e.includes(t.slice(t.lastIndexOf("[") + 1, -1))
                  ? "[" + "a".repeat(t.length - 2) + "]"
                  : t,
              ));
          }
          ((n = n.replace(this.tokenizer.rules.inline.anyPunctuation, "++")),
            (n = n.replace(this.tokenizer.rules.inline.blockSkip, (e, t, n) => {
              let r = n ? n.length : 0;
      ...
      Se = class {
        ...
        image({ href: e, title: t, text: n, tokens: r }) {
          ...
          let s = fe(e);
          if (null === s) return de(n);
          let l = `<img src="${(e = s)}" alt="${de(n)}"`;
          return (t && (l += ` title="${de(t)}"`), (l += ">"), l);
        }
        text(e) {
      ...
      Ae = class {
        ...
        provideLexer(e = this.block) {
          return e ? Re.lex : Re.lexInline;
        }
        provideParser(e = this.block) {
          return e ? ze.parse : ze.parseInline;
        }
      },
      _e = class {
        defaults = {
          ...
          return (
            e.forEach((e) => {
              ...
              if (
                ...
                let t = this.defaults.renderer || new Se(this.defaults);
              ...
              if (e.hooks) {
                let t = this.defaults.hooks || new Ae();
                for (let n in e.hooks) {
                  ...
                  Ae.passThroughHooks.has(n)
                    ? (t[r] = (e) => {
                        if (
                          this.defaults.async &&
                          Ae.passThroughHooksRespectAsync.has(n)
                        )
                          return (async () => {
        ...
        parseMarkdown(e) {
          return (t, n) => {
            ...
            try {
              ...
              let n = (
                s.hooks ? s.hooks.provideLexer(e) : e ? Re.lex : Re.lexInline
              )(t, s);
    ...
    ((Le.options = Le.setOptions =
      ...
      (Le.defaults = h),
      (Le.use = function (...e) {
        return (Pe.use(...e), (Le.defaults = Pe.defaults), p(Le.defaults), Le);
      }),
      (Le.walkTokens = function (e, t) {
        return Pe.walkTokens(e, t);
      }),
      (Le.parseInline = Pe.parseInline),
      (Le.Parser = ze),
      (Le.parser = ze.parse),
      (Le.Renderer = Se),
      (Le.TextRenderer = Te),
