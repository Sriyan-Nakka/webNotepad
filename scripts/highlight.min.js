...
var hljs = (function () {
      ...
      ((e) => {
        if (Array.isArray(e.begin)) {
          ...
          if ("object" != typeof e.beginScope || null === e.beginScope)
            throw (P("beginScope must be object"), q);
      ...
      ((e) => {
        if (Array.isArray(e.end)) {
          ...
          if ("object" != typeof e.endScope || null === e.endScope)
            throw (P("endScope must be object"), q);
  ...
  const te = (e) => ({
      ...
      UNICODE_RANGE: {
        scope: "number",
        begin:
          /\b[Uu]\+[0-9A-Fa-f][0-9A-Fa-f?]{0,4}(-[0-9A-Fa-f][0-9A-Fa-f]{0,4})?/,
      },
  ...
  function Ne(e) {
    ...
    const _ = [].concat(m, c.contains),
      ...
      v = {
        match: n.concat(
          /\b/,
          ((N = [...ye, "super", "import", "await"].map((e) => e + "\\s*\\(")),
          n.concat("(?!", N.join("|"), ")")),
          t,
          n.lookahead(/\s*\(/),
        ),
  ...
  var Pe = Object.freeze({
    ...
    grmr_cpp: (e) => {
      const n = e.regex,
        ...
        p = [m, c, s, t, e.C_BLOCK_COMMENT_MODE, l, o],
        _ = {
          variants: [
            { begin: /=/, end: /;/ },
            {
    ...
    grmr_swift: (e) => {
      const n = { match: /\s+/, relevance: 0 },
        ...
        i = { match: [/\./, m(...xe, ...Oe)], className: { 2: "keyword" } },
      ...
      const I = {
        ...
        F = {
          match: [/(func|macro)/, /\s+/, m(S.match, $e, Le)],
          className: { 1: "keyword", 3: "title.function" },
          contains: [L, B, n],
          illegal: [/\[/, /%/],
        },
